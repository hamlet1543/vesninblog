...
<!--                     <div class="modal-header">
    ...
    <h4 class="modal-title">Заголовок модального окна</h4>
        ...
        <nav class="settings-main">
            ...
            <div class="setting_list">
                <div v-if='settingsShow'>
                    <slider :name="'angle'" :ru="'Угол'" :valueLoad="this.angle" :min="-90" :max="90"></slider>
                    <slider :name="'distance'" :ru="'Расстояние'" :valueLoad="this.distance" :min="0" :max="350"></slider>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="task_header">
                    <h2 class="border-bottom text-center">{{nav_name}}</h2>            
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <div class="task_cards_list" v-if="show_list">
                                        <div class="task_card" v-for="(task,key) in this.tasks_this" v-bind:id="'task_'+key" v-bind:style="{ left: (key*distance+60)+'px', transform: 'rotateY('+angle+'deg)'}">
...
<script>
    export default {
        props:['tasks', 'tasks_done', 'folderName', 'nav_id', 'nav_name', 'angle_load', 'distance_load', 'images'], 
        data(){
            return{
                showDownload:false,
                imgName:'',
